...
<head>
    ...
    <script>
        ...
        function updateTable() {
            var a;
            if (document.getElementById("A001").checked)
                a = document.getElementById("A001").value;
            if (document.getElementById("A080").checked)
                a = document.getElementById("A080").value;
            if (document.getElementById("A090").checked)
                a = document.getElementById("A090").value;
            document.getElementById("aPointCurrent").innerHTML = a;
            document.getElementById("startDateCurrent").innerHTML = document.getElementById("startDate").value;
            document.getElementById("endDateCurrent").innerHTML = document.getElementById("endDate").value;
            ...
            $.ajax({
                ...
                success: function (data, textStatus) { // вешаем свой обработчик на функцию success
                    ...
                    for (var i = 0; i < col.length; i++) {
                        ...
                        var yearMonth = col[i].substring(0, 4) + "." + col[i].substring(4);
                        if (i == 0 || i == col.length - 1) {
                            th.innerHTML = col[i];
                        } else {
                            th.innerHTML = yearMonth;
                        }
                        tr.appendChild(th);
                    }
...
<div class="container float-left mt-4">
    ...
    <div class="row">
        <div class="col-2">A-point: </div> <div class="col"><p id="aPointCurrent"></p></div>
    </div>
    <div class="row">
        <div class="col-2">Start date: </div> <div class="col"><p id="startDateCurrent"></p></div>
    </div>
    <div class="row mb-3">
        <div class="col-2">End date: </div> <div class="col"><p id="endDateCurrent"></p></div>
    </div>
    <div class="row mb-4">
        <div class="col-12">
            <p id='showData'></p>
